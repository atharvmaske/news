  ...
  return (
    <>
      <div style={{ textAlign: "center", marginTop: "50px", height: "39rem" }}>
        ...
        <p>
          Hi! I'm Atharv Maske, a developer and tech enthusiast from Maharastra.
          I enjoy building apps that solve real problems.
        </p>
        <p>
          Feel free to connect with me on X,Github & LinkedIn, or check out my
          projects on GitHub.
        </p>
        ...
        >
          <a
            href="https://x.com/Atharv_maske_"
            target="_blank"
